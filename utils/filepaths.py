...
RSP_SCHEMA_DB = "assets/database/retail-sp-scheme.csv"
RTL_SCHEMA_DB = "assets/database/retail-tl-scheme.csv"
ENT_SCHEMA_DB = "assets/database/enterprise-scheme.csv"
